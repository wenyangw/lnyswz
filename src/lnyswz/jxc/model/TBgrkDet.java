...
/**
 * TBgrkDet generated by hbm2java
 */
@Entity
@Table(name = "t_bgrk_det")
public class TBgrkDet implements java.io.Serializable {
	...
	public TBgrkDet(int id, String spbh, String spmc, String spcd, String sppp, String spbz, String zjldwId,
                    String zjldwmc, String cjldwId, String cjldwmc, BigDecimal zhxs, BigDecimal zdwsl, TBgrk TBgrk) {
		this.id = id;
		this.spbh = spbh;
		this.spmc = spmc;
		this.spcd = spcd;
	...
	@JoinColumn(name = "bgrklsh", nullable = false)
	public TBgrk getTBgrk() {
		return this.TBgrk;
	}

	public void setTBgrk(TBgrk TBgrk) {
		this.TBgrk = TBgrk;
	}
}
