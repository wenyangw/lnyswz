...
/**
 * TBgzz generated by hbm2java
 */
@Entity
@Table(name = "t_bgzz")
public class TBgzz implements java.io.Serializable {
	...
	public TBgzz(int id, String spbh, String spmc, String spcd, String sppp, String spbz, String zjldwId, String zjldwmc,
                 String cjldwId, String cjldwmc, BigDecimal zhxs, String bmbh, String bmmc, BigDecimal qcsl, BigDecimal rksl, BigDecimal cksl, String jzsj) {
		this.id = id;
		this.spbh = spbh;
		this.spmc = spmc;
		this.spcd = spcd;
