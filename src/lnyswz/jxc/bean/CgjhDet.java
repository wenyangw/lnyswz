...
public class CgjhDet {
	...
	public BigDecimal getZdwjhsl() {
		return zdwjhsl;
	}

	public void setZdwjhsl(BigDecimal zdwjhsl) {
		this.zdwjhsl = zdwjhsl;
	}

	public BigDecimal getCdwjhsl() {
		return cdwjhsl;
	}

	public void setCdwjhsl(BigDecimal cdwjhsl) {
		this.cdwjhsl = cdwjhsl;
	}
