...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/utils.js?v=20160701"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/jxc.js?v=20160629"></script>
