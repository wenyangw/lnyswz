...
*******************************************************************************/
var messageUploadNews =  new Array();
(function (window, undefined) {

	if (window.KindEditor) {
		alert("window.KindEditor");
		return;
	}
if (!window.console) {
			...
			yesBtn : {				
				...
				click : function(e) {					
					...
					if (showLocal && showRemote && tabs && tabs.selectedIndex === 0 || !showRemote) {
						console.info(tabs);
						console.info(tabs.selectedIndex );
		...
		var uploadbutton = K.uploadbutton({
			...
			afterUpload : function(data) {
				...
				if (data.error === 0) {
					...
					messageUploadNews.push(realUrl);
					...
					if (!fillDescAfterUploadImage) {
						clickFn.call(self, url, data.title, '600px',data.height, data.border, "center");
					} else {
