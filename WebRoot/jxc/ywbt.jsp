...
function saveAll(){
	...
	let hjje1 = $('#jxc_ywbt_hjje1').numberbox('getValue') === '' ? 0 : $('#jxc_ywbt_hjje1').numberbox('getValue');
	let hjje2 = $('#jxc_ywbt_hjje2').numberbox('getValue') === '' ? 0 : $('#jxc_ywbt_hjje2').numberbox('getValue');
	let btje = footerRows[0]['btje'];
